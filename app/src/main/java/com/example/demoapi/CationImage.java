...
public class CationImage extends RecyclerView.Adapter<CationImage.ViewHolder> {
    Context context;
    ArrayList<String>imageList;
    int size=0;
    public CationImage(Context context, ArrayList<String>imageList){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        CardView v = (CardView) LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_captioned_image,
                parent,
                false);
